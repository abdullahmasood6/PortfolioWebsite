  ...
  <section id="about" className="section">
    ...
    <div style={aboutStyle}>
      <div style={{ fontSize: "1.1rem", lineHeight: 1.7 }}>
        ...
        My work spans <span style={highlight}>Playwright‑based data broker scraping</span>, <span style={highlight}>NestJS + AWS</span> services, and production monitoring to keep pipelines resilient as sites change. I’ve shipped improvements like <span style={highlight}>proxy routing</span>, <span style={highlight}>session rotation</span>, and hardened error handling to overcome Cloudflare, reCAPTCHA, and rate limits — improving scan success and performance.<br /><br />
